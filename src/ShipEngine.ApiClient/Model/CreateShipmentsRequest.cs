...
namespace ShipEngine.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateShipmentsRequest :  IEquatable<CreateShipmentsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateShipmentsRequest);
        }

        /// <summary>
        /// Returns true if CreateShipmentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateShipmentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateShipmentsRequest input)
        {
            if (input == null)
                return false;
