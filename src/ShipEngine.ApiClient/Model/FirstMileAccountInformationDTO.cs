...
namespace ShipEngine.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FirstMileAccountInformationDTO :  IEquatable<FirstMileAccountInformationDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FirstMileAccountInformationDTO {\n");
        ...
        {
            return this.Equals(input as FirstMileAccountInformationDTO);
        }

        /// <summary>
        /// Returns true if FirstMileAccountInformationDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of FirstMileAccountInformationDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FirstMileAccountInformationDTO input)
        {
            if (input == null)
                return false;
