    ...
    public partial class CreateShipmentResponse :  IEquatable<CreateShipmentResponse>, IValidatableObject
    {
        ...
        public bool Equals(CreateShipmentResponse input)
        {
            ...
            return 
                ...
                (
                    this.AddressValidation == input.AddressValidation ||
                    (this.AddressValidation != null &&
                    this.AddressValidation.Equals(input.AddressValidation))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AddressValidation != null)
                    hashCode = hashCode * 59 + this.AddressValidation.GetHashCode();
