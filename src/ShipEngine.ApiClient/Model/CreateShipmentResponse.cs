...
namespace ShipEngine.ApiClient.Model
{
    ...
    public class CreateShipmentResponse : IEquatable<CreateShipmentResponse>, IValidatableObject
    {
        ...
        public CreateShipmentResponse(List<string> errors = default(List<string>),
            AddressValidationResponseDTO addressValidation = default(AddressValidationResponseDTO),
        ...
        /// </summary>
        [DataMember(Name = "address_validation", EmitDefaultValue = false)]
        public AddressValidationResponseDTO AddressValidation { get; set; }
        ...
        /// </summary>
        /// <param name="other">Instance of CreateShipmentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateShipmentResponse other)
        {
            ...
            return
                ...
                (
                    Equals(AddressValidation, other.AddressValidation) ||
                    AddressValidation != null &&
                    AddressValidation.Equals(other.AddressValidation)
                ) &&
                (
        ...
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            return Equals(obj as CreateShipmentResponse);
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hash = hash * 59 + AddressValidation.GetHashCode();
                }
                if (ShipmentId != null)
                {
