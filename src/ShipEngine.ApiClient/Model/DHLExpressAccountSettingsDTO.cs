...
namespace ShipEngine.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DHLExpressAccountSettingsDTO :  IEquatable<DHLExpressAccountSettingsDTO>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DHLExpressAccountSettingsDTO);
        }

        /// <summary>
        /// Returns true if DHLExpressAccountSettingsDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of DHLExpressAccountSettingsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DHLExpressAccountSettingsDTO input)
        {
            if (input == null)
                return false;
